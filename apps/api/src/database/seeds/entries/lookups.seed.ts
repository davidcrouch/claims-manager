...
const LOOKUP_SPECS: readonly LookupSpec[] = [
  ...
  { domain: 'invoice_status', name: 'Reviewed', ref: 'invoice-status-reviewed' },
  { domain: 'invoice_status', name: 'Invoiced', ref: 'invoice-status-invoiced' },
  { domain: 'invoice_status', name: 'Partially Paid', ref: 'invoice-status-partially-paid' },
  { domain: 'invoice_status', name: 'Paid', ref: 'invoice-status-paid' },
  ...
  { domain: 'bill_status', name: 'Reviewed', ref: 'bill-status-reviewed' },
