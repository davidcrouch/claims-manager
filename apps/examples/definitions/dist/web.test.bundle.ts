...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@22.19.11_jiti@2.6.1_jsdom@25.0.1_lightningcss@1._ijyy6n4p2yinsx4cxbj6fknj34/node_modules/vitest/dist/chunks/utils.XdZDrNZV.js
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@22.19.11_jiti@2.6.1_jsdom@25.0.1_lightningcss@1._ijyy6n4p2yinsx4cxbj6fknj34/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@22.19.11_jiti@2.6.1_jsdom@25.0.1_lightningcss@1._ijyy6n4p2yinsx4cxbj6fknj34/node_modules/vitest/dist/chunks/date.Bq6ZW5rf.js
var RealDate = Date;
var now2 = null;
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@22.19.11_jiti@2.6.1_jsdom@25.0.1_lightningcss@1._ijyy6n4p2yinsx4cxbj6fknj34/node_modules/vitest/dist/chunks/vi.bdSIJ99Y.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+debug@4.1.12_@types+node@22.19.11_jiti@2.6.1_jsdom@25.0.1_lightningcss@1._ijyy6n4p2yinsx4cxbj6fknj34/node_modules/vitest/dist/index.js
var import_expect_type = __toESM(require_dist(), 1);

// definitions/implementations/web.ts
function requireString2(input, key) {
  const v2 = input[key];
...
async function search(input, _context) {
  try {
    const query = requireString2(input, "query");
    if (!query) {
...
async function searchWithCustomApi(params) {
  ...
  if (Array.isArray(data.results)) {
    const results = data.results.slice(0, numResults).map((r2) => ({
      title: r2.title || "",
      url: r2.url || r2.link || "",
      snippet: r2.snippet || r2.content || r2.description || ""
    }));
...
async function fetch(input, _context) {
  try {
    const url = requireString2(input, "url");
    if (!url) {
    ...
    const method = (requireString2(input, "method") || "GET").toUpperCase();
    ...
    if (input.headers && typeof input.headers === "object" && !Array.isArray(input.headers)) {
      for (const [k2, v2] of Object.entries(input.headers)) {
        headers[k2] = String(v2);
      }
    }
    const bodyStr = requireString2(input, "body") || void 0;
...
// definitions/implementations/web.test.ts
var LOG2 = "more0ai:web";
describe("tool.os.web", () => {
  ...
  afterEach(() => {
    ...
    if (originalEnv !== void 0) process.env.SEARCH_API_URL = originalEnv;
    else delete process.env.SEARCH_API_URL;
  });
  describe("search", () => {
    it("returns error when query is missing", async () => {
      const result = await search({}, {});
      globalExpect(result).toEqual({ error: `${LOG2}:search - 'query' is required` });
    });
    ...
    it("returns parsed results when DuckDuckGo returns Abstract + RelatedTopics", async () => {
      ...
      globalExpect(result).not.toHaveProperty("error");
      globalExpect(result).toMatchObject({
        query: "Node.js LTS schedule",
        total: 3
      });
      globalExpect(Array.isArray(result.results)).toBe(true);
      const results = result.results;
      globalExpect(results).toHaveLength(3);
      globalExpect(results[0]).toEqual({
        title: "Node LTS",
        url: "https://nodejs.org/en/about/previous-releases",
        snippet: "Node.js LTS schedule summary"
      });
      globalExpect(results[1].url).toBe("https://example.com/1");
      globalExpect(results[2].url).toBe("https://example.com/2");
    });
    it("returns results from custom search API when SEARCH_API_URL is set", async () => {
      ...
      globalThis.fetch = vi.fn((input) => {
        ...
        globalExpect(url).toContain("https://custom.search/api");
        globalExpect(url).toContain("q=");
        globalExpect(url).toContain("limit=");
      ...
      globalExpect(result).not.toHaveProperty("error");
      globalExpect(result).toMatchObject({ query: "TypeScript 5", total: 2 });
      const results = result.results;
      globalExpect(results[0]).toEqual({ title: "Custom 1", url: "https://a.com/1", snippet: "Snippet 1" });
      globalExpect(results[1]).toEqual({ title: "Custom 2", url: "https://a.com/2", snippet: "Snippet 2" });
    });
  ...
  describe("fetch", () => {
    it("returns error when url is missing", async () => {
      ...
      globalExpect(result).toEqual({ error: `${LOG2}:fetch - 'url' is required` });
    });
    it("returns error when url does not start with http:// or https://", async () => {
      const result = await fetch({ url: "ftp://example.com" }, {});
      globalExpect(result).toEqual({ error: `${LOG2}:fetch - URL must start with http:// or https://` });
    });
    it("returns status, headers and body when GET succeeds", async () => {
      ...
      globalExpect(result.headers).toBeDefined();
      globalExpect(result.content_type).toContain("text/plain");
    });
    it("returns error when fetch throws", async () => {
      ...
      globalExpect(result.error).toContain("Network failure");
    });
  });
});
