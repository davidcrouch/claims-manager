...
export default function createGoogleRoutes(app: Application, provider?: any): void {
   ...
   // SECURITY (F-04): `/complete-signup` was removed. It accepted an arbitrary
   // userId/email in an unauthenticated request and completed the OIDC
   // interaction as that account. Live Google and password registration
   // complete the interaction directly via provider.interactionFinished.
