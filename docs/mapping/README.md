...
| [`jobs.md`](./jobs.md) | Job | `docs/Insurance REST API-v17-20260304_100318.pdf` §3.2 | Stub (minimum mapper coverage) |
| [`quotes.md`](./quotes.md) | Quote | `docs/Insurance REST API-v17-20260304_100318.pdf` §3.5 | Stub (minimum mapper coverage) |
| [`reports.md`](./reports.md) | Report | `docs/Insurance REST API-v17-20260304_100318.pdf` §3.6 | Stub (minimum mapper coverage) |
| [`appointments.md`](./appointments.md) | Appointment | `docs/Insurance REST API-v17-20260304_100318.pdf` §3.7 | Stub (minimum mapper coverage) |
...
- **Destination** is exactly one of:
  ...
  - a **JSONB bucket** (`address`, `policy_details`, `financial_details`, `vulnerability_details`, `contention_details`, `custom_data`) with a specific key inside that bucket
  - a **child table** row (e.g. `claim_contacts`, `claim_assignees`)
