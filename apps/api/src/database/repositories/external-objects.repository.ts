    ...
    const [row] = await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          latestEventType: sql`excluded.latest_event_type`,
          latestEventTimestamp: sql`excluded.latest_event_timestamp`,
          externalCreatedAt: sql`excluded.external_created_at`,
          externalUpdatedAt: sql`excluded.external_updated_at`,
