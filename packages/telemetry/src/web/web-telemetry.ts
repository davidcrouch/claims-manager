...
export async function createWebTracerProvider(config: WebTelemetryConfig) {
  ...
  const Resource = (resources as any).Resource || resources.default;
...
export async function startWebTelemetry(config: WebTelemetryConfig) {
