...
const STEP_TO_LOOKUP: Record<string, Record<string, { domain: string; name: string }>> = {
  ...
  invoice: {
    ...
    reviewed:  { domain: LOOKUP_DOMAINS.INVOICE_STATUS, name: 'Reviewed' },
    invoiced:      { domain: LOOKUP_DOMAINS.INVOICE_STATUS, name: 'Invoiced' },
    submitted:     { domain: LOOKUP_DOMAINS.INVOICE_STATUS, name: 'Invoiced' },
    partially_paid: { domain: LOOKUP_DOMAINS.INVOICE_STATUS, name: 'Partially Paid' },
  ...
  bill: {
    ...
    reviewed:     { domain: LOOKUP_DOMAINS.BILL_STATUS, name: 'Reviewed' },
