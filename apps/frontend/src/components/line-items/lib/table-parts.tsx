...
export function LineItemsColGroup(props: TableLayoutProps) {
  ...
  const cols = [
    ...
    showCategory ? <col key="category" className="w-[180px]" /> : null,
    showItemTypeColumn ? <col key="type" className="w-[110px]" /> : null,
  ...
  return (
    <thead className="bg-slate-50/60">
      <tr className={cn('text-left text-[11px] font-medium uppercase tracking-wide text-slate-400', LI_TH_NOWRAP)}>
        ...
        {showCategory && <th scope="col" className="px-2 py-1.5">Category</th>}
        {showItemTypeColumn && <th scope="col" className="px-2 py-1.5">Type</th>}
