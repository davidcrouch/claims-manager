...
export async function createNodeSDK(config) {
    const [{ NodeSDK }, { resourceFromAttributes }, { ATTR_SERVICE_NAME, ATTR_SERVICE_VERSION }, { getNodeAutoInstrumentations }, { OTLPTraceExporter }, { PeriodicExportingMetricReader }, { OTLPMetricExporter },] = await Promise.all([
...
export async function startNodeTelemetry(config) {
...
//# sourceMappingURL=node-telemetry.js.map